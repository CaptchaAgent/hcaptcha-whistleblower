...
class CollectorSettings:
    ...
    FOCUS_LABELS = {
        ...
        # adafb813-8b5c-473f-9de3-485b4ad5aa09 一条脖子上有项圈的狗
        "dog with a collar on its neck": "dog_with_a_collar_on_its_neck",

        # c86d730b-300a-444c-a8c5-5312e7a93628 张开嘴的狮子
        "lion with an open mouth": "lion_with_an_open_mouth",

        # adafb813-8b5c-473f-9de3-485b4ad5aa09 一只闭着嘴的狮子
        "lion with a closed mouth": "lion_with_a_closed_mouth",

        # edc4ce89-8903-4906-80b1-7440ad9a69c8 朝左马
        "horse facing to the left": "horse_facing_to_the_left",

        # adafb813-8b5c-473f-9de3-485b4ad5aa09 一只小猫
        "baby cat": "baby_cat",

        # 91e4137f-95af-4bc9-97af-cdcedce21c8c
        "cat with short hair": "cat_with_short_hair",

        # adafb813-8b5c-473f-9de3-485b4ad5aa09
        "cat with thick fur": "cat_with_thick_fur",
